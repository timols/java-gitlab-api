...
public class MyGitlabAPIT {

    GitlabAPI api;

    private static final String TEST_URL = System.getProperty("TEST_URL", "http://172.17.128.73");
    private static final String TEST_TOKEN = System.getProperty("TEST_TOKEN", "iJRLG-WzyU8BTxNFR-rf");
    ...
    public void testGetProjectByName(){
    	try {
			GitlabProject project = api.getProject("GROUP01", "GP_ESB");
    ...
    public void testGetProjectID(){
    	try {
			GitlabProject project = api.getProject("61");
			System.out.println(project.getName());
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
