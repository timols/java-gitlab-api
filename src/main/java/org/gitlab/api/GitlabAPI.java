...
public class GitlabAPI {
	 ...
	 * @param ldapAccess
	 *            Access level for LDAP group members, null otherwise
	 * 
	 * @return The GitLab Group
	 */
	 ...
	 *            The name of the project
	 * @param namespaceId
	 *            The Namespace for the new project, otherwise null indicates to
	 *            use the GitLab default (user)
	 * @param description
	 *            A description for the project, null otherwise
	 * @param issuesEnabled
	 *            Whether Issues should be enabled, otherwise null indicates to
	 *            use GitLab default
	 * @param wallEnabled
	 *            Whether The Wall should be enabled, otherwise null indicates
	 *            to use GitLab default
	 * @param mergeRequestsEnabled
	 *            Whether Merge Requests should be enabled, otherwise null
	 *            indicates to use GitLab default
	 * @param wikiEnabled
	 *            Whether a Wiki should be enabled, otherwise null indicates to
	 *            use GitLab default
	 * @param snippetsEnabled
	 *            Whether Snippets should be enabled, otherwise null indicates
	 *            to use GitLab default
	 * @param publik
	 *            Whether the project is public or private, if true same as
	 *            setting visibilityLevel = 20, otherwise null indicates to use
	 *            GitLab default
	 * @param visibilityLevel
	 *            The visibility level of the project, otherwise null indicates
	 *            to use GitLab default
	 * @param importUrl
	...
	public GitlabProject createProject(String name, Integer namespaceId, String description, Boolean issuesEnabled, Boolean wallEnabled,
		...
		Query query = new Query().append("name", name).appendIf("namespace_id", namespaceId).appendIf("description", description)
				.appendIf("issues_enabled", issuesEnabled).appendIf("wall_enabled", wallEnabled).appendIf("merge_requests_enabled", mergeRequestsEnabled)
				.appendIf("wiki_enabled", wikiEnabled).appendIf("snippets_enabled", snippetsEnabled).appendIf("public", publik)
				.appendIf("visibility_level", visibilityLevel).appendIf("import_url", importUrl);
	 ...
	 *            A description for the project, null otherwise
	 * @param defaultBranch
	 *            The default branch for the project, otherwise null indicates
	 *            to use GitLab default (master)
	 * @param issuesEnabled
	 *            Whether Issues should be enabled, otherwise null indicates to
	 *            use GitLab default
	 * @param wallEnabled
	 ...
	 * @return The GitLab Project
	 */
	public GitlabProject createUserProject(Integer userId, String name, String description, String defaultBranch, Boolean issuesEnabled, Boolean wallEnabled,
			Boolean mergeRequestsEnabled, Boolean wikiEnabled, Boolean snippetsEnabled, Boolean publik, Integer visibilityLevel) throws IOException {
